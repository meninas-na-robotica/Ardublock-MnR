...
Blockly.Arduino['sim800_send']=function(block){
 ...
 '   delay(100); \n '+
 '   sim800l.println("AT + CMGS = \\"+'+valuetell_number+'\\"");   \n '+
 '   delay(100);  \n '+
...
// lcd
Blockly.Arduino['lcd_bottom']=function(block){
    var valuebottom_dropdown = block.getFieldValue('bottom_dropdown');
	
	if (valuebottom_dropdown == "1"){
    var code = 'analogRead(A0) > 10 & analogRead(A0) < 99';
	}
	if (valuebottom_dropdown == "2"){
	var code = 'analogRead(A0) > 100 & analogRead(A0) < 199';
	}
	if (valuebottom_dropdown == "3"){
	var code = 'analogRead(A0) > 200 & analogRead(A0) < 399';
	}
	if (valuebottom_dropdown == "4"){
	var code = 'analogRead(A0) > 400 & analogRead(A0) < 599';
	}
	if (valuebottom_dropdown == "5"){
	var code = 'analogRead(A0) > 600 & analogRead(A0) < 799';
	}
