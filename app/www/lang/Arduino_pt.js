...
Blockly.Msg.CAT_ARDUINO_moteur="↻ Motor de Passo";
...
//Wireless
Blockly.Msg.esp8266_init_tooltip = "inicialização do módulo Wi-Fi e conexão com os parâmetros indicados";
...
Blockly.Msg.esp8266_request_container = "encontramos";//"we find";
//INTERRUPTION
Blockly.Msg.LKL_ATTACHINTERRUPT_PIN = 'Interrupção: quando um';//'Interrupt: when a';
Blockly.Msg.LKL_DETACHINTERRUPT_PIN = "desabilitar interrupção no pino";
Blockly.Msg.LKL_TOOLTIP_INOUT_ATTACHINTERRUPT = "Especifica uma ação a ser tomada quando ocorre uma interrupção externa (4 modos possíveis) nos pinos 2 ou 3";
...
Blockly.Msg.LCDi2c_tooltip = "inicializa o LCD I2C de 2 linhas e 16 caracteres com backlight RGB. \n Dispositivo de exibição <-> Arduino \nSDA <--------> A4 \nSCL <- -------> A5 ";
...
Blockly.Msg.LCD_SHIELD_PRINT_TEXT_tooltip = "exibir o texto na localização especificada";
Blockly.Msg.LCD_SHIELD_PRINT_TOOLTIP = "escrever o texto no visor do LCD";
...
Blockly.Msg.LCD_raz = "apagar a tela do LCD";
Blockly.Msg.LCD_raz_tooltip = "limpar tela";
Blockly.Msg.lcd_aff_symbole = "exibir o símbolo";
Blockly.Msg.lcd_aff_symbole_tooltip = "mostrar o símbolo que foi definido anteriormente";
...
//matrix
Blockly.Msg.matriceLC = "colocar o LED, linha";
Blockly.Msg.matrice_create_aff = "Criar bloco 'exibir símbolo %1'";
Blockly.Msg.matrice_create_symbole = "Criar o bloco 'definir o símbolo %1'";
Blockly.Msg.matrice = "matriz";
Blockly.Msg.matrice8x8_tooltip = "Inicialização da matriz para 64 LEDs, é necessário indicar os pinos do Arduino aos quais serão conectados DIN, CLK e CS";
...
Blockly.Msg.matrice8x8_binaire_tooltip = "1 acende um LED da matriz e 0 o apaga.";
Blockly.Msg.matrice8x8_del_tooltip = "Acende (apaga) um LED na matriz indicando suas coordenadas \nCuidado, a numeração das coordenadas começa em 0.";
...
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TOOLTIP = "Girar o servo conectado ao pino especificado, na velocidade indicada e na direção selecionada";
//engine
...
Blockly.Msg.moteurstop = "parar o motor";
...
Blockly.Msg.m_pap_step1= "avançar";//"move forward";
...
Blockly.Msg.repl_read = "o usuário inseriu um comando";
// software serial
...
Blockly.Msg.CAT_DISPLAYU_LCDP = "Display LCD";
...
Blockly.Msg.ledstrip_WS5 = "D - Pixel definido para iniciarо";
